...
## Answer
A. Partition by dropoff time column and cluster on VendorID
...
## Answer
It shows 0 because we are not selecting any particular column and BigQuery tables are columnwise stored
