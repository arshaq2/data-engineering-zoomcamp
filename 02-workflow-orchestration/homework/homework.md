...
Answer: a. 128.3 Mib (see screenshot)
...
Process: Used the backfill execution for green taxi data for the year 2020.
...
Answer. According to the documentation, we got to use the timezone identifier i.e. `timezone: America/New_York` 
